...
public class WidgetColorSelector extends Button implements IGui {
	...
	public WidgetColorSelector(MTRScreen screen, boolean hasMargin, Runnable callback) {
		super(0, 0, 0, SQUARE_SIZE, Text.literal(""), button -> {}, DEFAULT_NARRATION);
		this.screen = screen;
	...
	private static class ColorSelectorScreen extends MTRScreen {
